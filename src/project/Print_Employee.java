...
class Print_Employee implements ActionListener{
    JFrame f;
    JLabel id8,id,aid,id1,aid1,id2,aid2,id3,aid3,id4,aid4,id5,aid5,id6,aid6,id7,aid7,id9,id10,id11,id12,id13,id14,id15,id16,id17,lab,aid10,aid11,id18;
    ...
    Print_Employee(String e_id){
        ...
        id9=new JLabel();
        id9.setBounds(0,0,900,800);
        id9.setLayout(null);
       ImageIcon img=new ImageIcon("C:\\Users\\HP\\Downloads\\andres-umana-YVuWpmiIWJo-unsplash.jpg");
        id9.setIcon(img);
        ...
        id18=new JLabel("Aadhar");
        id18.setBounds(50,470,100,30);
        id18.setFont(new Font("serif",Font.BOLD,20));
        id9.add(id18);
        
        aid11=new JLabel(aadhar);
        aid11.setBounds(200,470,300,30);
